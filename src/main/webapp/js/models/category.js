function initcategory() {
    //查询控制器
    var url_listall = "listallCategory";
    //删除控制器
    var url_delete = "deleteallCategory";
    //插入控制器
    var url_insert = "insertSelectiveCategory";
    //更新控制器
    var url_update = "updateByPrimaryKeySelectiveCategory";
    ...
    var title_insert = "插入教材类别信息";
    var title_update = "更新教材类别信息";
